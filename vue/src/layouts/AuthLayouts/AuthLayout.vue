            ...
            <div class="sign-in-detail text-white" :style="'background: url('+bgImageURL+') no-repeat 0 0; background-size: cover;'">
              ...
              <Swiper :options="options">
                <SwiperSlide class="item">
                  <img :src="require('../../assets/images/login/23.png')" class="img-fluid mb-4" alt="logo">
                  <h4 class="mb-1 text-white">管理你的系统</h4>
...
import bgImage from '../../assets/images/login/23.png'
